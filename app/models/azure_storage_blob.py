...
from app.models.standard_model import DatabaseOperationError, IDataStore
from app.models.User import User


def handle_azure_operation_failure(func):
    def wrapper(*args, **kwargs):
        try:
            return func(*args, **kwargs)
        except Exception:
            logging.exception("Error occurred when interact with Azure Storage")
...
class AzureBlob(IDataStore):
    ...
    @handle_azure_operation_failure
