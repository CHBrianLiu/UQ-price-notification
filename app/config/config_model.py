...
class AppConfig(BaseModel):
    ...
    LINE_RICH_MENU_ENDPOINT: str
    LINE_RICH_MENU_WITH_ID_ENDPOINT: str
    LINE_RICH_MENU_LIST_ENDPOINT: str
    LINE_RICH_MENU_IMAGE_ENDPOINT: str
    LINE_RICH_MENU_DEFAULT_ENDPOINT: str
    LINE_RICH_MENU_NAME: str

    # OPERATION PATTERNS
    LIST_REGEX_PATTERN: str
